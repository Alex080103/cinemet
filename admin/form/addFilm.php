          ...
          <div class="tab bg-darkBlue rounded-lg grid-cols-2 gap-32 items-center grid shadow-lg p-4 px-6">
              <div>
                ...
                <div class="mb-4">
                  ...
                  <select id="monSelect" placeholder="Votre adresse" name="director"  class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:shadow-outline-blue">          
                  ...
                  value="<?php echo $actor['id_acteur'].'-'.$actor['nom_acteur']; ?>">
                    <?php echo $actor['id_acteur'].'-'. $actor['nom_acteur']; ?>
                  </option>
                  <?php    
                        }
                  ?>
                  </select>
                  <p onclick="addSelect()" class="cursor-pointer w-1/2 bg-sand hover:scale-105 transition-all text-white font-medium py-2 px-4 rounded-lg mr-2">
                    Ajouter un acteur
                  </p>
                  <div id="conteneur">
                  </div>
              ...
              <div>
                <div class="mb-4">
                  ...
                  <select placeholder="Votre adresse" name="director"  class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:shadow-outline-blue">          
                    <?php   
                            try {
                              $req = selectReal();
                            } catch (Exception $e) {
                    ...
                    ?>
                      ...
                      <option value="<?php echo $real['nom_real'];?>"><?php echo $real['nom_real'];?></option>
                    <?php    $i++;
                        }
