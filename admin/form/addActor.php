...
<html lang="en" class="scroll-smooth">
    ...
    <body class="bg-darkBlue h-screen">
        ...
        <form action="../../admin/add_Actor.php" class="form-container" method="POST" onsubmit="submit()">
            ...
            <div class="bg-opacity-50 py-8 relative w-11/12 mx-auto mb-8" id="popup-Form">
                <div class="bg-darkBlue border-2 border-sand shadow-md  shadow-whitePrimary rounded-lg max-w-2xl w-full mx-auto">
                    ...
                    <div class="tab bg-darkBlue rounded-lg gap-32 items-center grid shadow-lg p-4 px-6">
                        <div>
                            <div class="mb-4">
                              <label for="email" class="block text-whitePrimary font-medium mb-2 text-2xl">Nom de l'acteur</label>
                            ...
                            <div class="mb-4">
                              <label for="email" class="block text-whitePrimary font-medium mb-2 text-2xl">Prénom de l'acteur</label>
                            ...
                            <div class="mb-4">
                              <label for="psw" class="block text-whitePrimary font-medium mb-2 text-2xl">Age de l'acteur</label>
                            ...
                            <div class="mb-4">
                              <label for="psw" class="block text-whitePrimary font-medium mb-2 text-2xl">Nationalité de l'acteur</label>
                            ...
                            <div class="mb-4">
                             <label for="psw" class="block text-whitePrimary font-medium mb-2 text-2xl">Photo de l'acteur :</label>
