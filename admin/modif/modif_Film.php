...
if (isset($_POST['name'])) {
        ...
        /*******AJOUT DU PRODUIT******/
            ...
            try {
                modifFilm($name, $date, $country, $synopsis, $id_film);
                $y = 1;
            } catch (Exception $e) {
            ...
            if(isset($filenamePoster) ) {
                try {
                    modifPoster($filenamePoster, $id_film);
                } catch (Exception $e) {
                    die('Erreur : '.$e->getMessage());
                } 
            }
            ...
            if(isset($filenameImage) ) {
                try {
                    modifImage($filenameImage, $id_film);
                } catch (Exception $e) {
                    die('Erreur : '.$e->getMessage());
                } 
            }
    ...
    $id_cat = $_POST['cat'];
        ...
        modifFilmActor($id_film);
        modifFilmReal($id_real, $id_film);
        modifFilmCat($id_cat, $id_film);
